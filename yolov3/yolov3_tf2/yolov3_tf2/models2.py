...
def YoloV3(yolo_max_boxes, yolo_iou_threshold, yolo_score_threshold, size=None, channels=3, anchors=yolo_anchors,
...
def YoloV3Tiny(yolo_max_boxes, yolo_iou_threshold, yolo_score_threshold, size=None, channels=3, anchors=yolo_tiny_anchors,
